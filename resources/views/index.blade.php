...
@section('page-content')
    ...
    <div class="reveal w-full h-full bg-no-repeat bg-cover"
    ...
    <section class="py-20 text-white">
        <div class="max-w-screen-md mx-auto">
            <h3 class="text-4xl font-bold-mb-6">Bagaimana jika ingin bergabung?</h3>
            <h3 class="text-xl mb-6">Cari Tahu banyak tentang kami disini</h3>
